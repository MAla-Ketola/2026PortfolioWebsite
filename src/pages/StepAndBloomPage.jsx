...
import StepAndBloom from "../components/step-and-bloom/StepAndBloom";
import Footer from "../components/Footer";

const sections = [
  { id: "overview",       label: "OVERVIEW",              color: "#FFFFFF" },
  { id: "project-summary", label: "PROJECT SUMMARY",        color: "#25E995" },
  { id: "ux-design",       label: "UX & INTERFACE DESIGN",  color: "#F087FE" },
  { id: "technical",       label: "TECHNICAL ARCHITECTURE", color: "#FED814" },
  { id: "lessons",         label: "LESSONS LEARNED",        color: "#01D6FB" },
];
...
export default function StepAndBloomPage() {
  return (
    <>
