    ...
    <>
      ...
      >
        ...
        <h1
          ...
          style={{ fontFamily: "'Milkyway', sans-serif", textShadow: "4px 4px 0 #FED814" }}
        >
          Step & Bloom
        </h1>
        <motion.p
        ...
        >
          Turn daily walks into virtual gardens—a Unity mobile prototype that treats real steps as in-game currency, rewarding users with blooming flowers, badges and levels.
        </motion.p>
      </motion.div>

      {/* Video + Meta side by side */}
