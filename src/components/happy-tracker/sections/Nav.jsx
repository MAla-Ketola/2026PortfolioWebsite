...
export default function Nav() {
  const steps = [
    ...
    { id: "design-process", label: "DESIGN PROCESS", emoji: "✏️" },
          ...
          >
            <div className="relative flex items-center justify-center">
              ...
              <div className="absolute inset-0 flex flex-col items-center justify-center gap-2 pb-3">
                ...
                <span className="text-[10px] md:text-sm font-black uppercase tracking-wider text-black text-center leading-tight px-1">
                  {s.label}
                </span>
              </div>
            </div>
